define([
  ...
  // Oliver Added Custom because custom.js didn't work
  //CodeMirror.Vim.map('j', '<Plug>(vim-binding-h)', 'normal');
  //CodeMirror.Vim.map('k', '<Plug>(vim-binding-j)', 'normal');
  //CodeMirror.Vim.map('l', '<Plug>(vim-binding-k)', 'normal');
  //CodeMirror.Vim.map(';', '<Plug>(vim-binding-l)', 'normal');
